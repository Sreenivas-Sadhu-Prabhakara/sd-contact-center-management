package com.bank.bian.contactcentermanagement.model;
...
/**
 * The BIAN control record for this service domain: "Contact Center Plan Management Plan".
 *
 ...
 * to its asset type (Contact Center Plan). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Contact Center Plan Management Plan";
